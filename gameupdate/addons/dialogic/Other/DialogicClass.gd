...
static func start(Callable(timeline: String = '', default_timeline: String ='').bind(dialog_scene_path: String="res://addons/dialogic/Nodes/DialogNode.tscn"), debug_mode: bool=false, use_canvas_instead=true):
